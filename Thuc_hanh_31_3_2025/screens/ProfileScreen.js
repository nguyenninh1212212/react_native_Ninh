  ...
  return (
    <ScrollView  style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Image source={{ uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPq_GdHrAfGdnr3cLDeagSc7X_twjR_6Cz9Q&s"}} style={styles.profileImage} />
    ...
    <View style={{padding:20}}>
      ...
      <TouchableOpacity style={styles.option1}>
        <Text style={[styles.optionText, { color: 'white' ,textAlign:"center"}]}>Log Out</Text>
